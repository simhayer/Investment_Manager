public class Stock extends Investment {
    ...
    public Stock(){             //standard no arg consrtuctor
      buyCOMMISSION = 9.9f;
      sellCOMMISSION = 9.9f;
      type = 0;
    }
      
      public Stock(String name,String symbol, float price,int quantity){        //standard called constructor
      ...
      public Stock(String name,String symbol, float price,int quantity, float bookValue){        //standard called constructor
        buyCOMMISSION = 9.9f;
        sellCOMMISSION = 9.9f;
        type = 0;
        this.name = name;
